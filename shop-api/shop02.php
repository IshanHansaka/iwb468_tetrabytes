...
switch ($method) {
    ...
    case 'POST':
        ...
        $conn->query("INSERT INTO shop02 (model_name, price, warranty, in_stock) VALUES ('$model_name', $price, '$warranty', $in_stock)");
    ...
    case 'PUT':
        ...
        $conn->query("UPDATE shop02 SET model_name='$model_name', price=$price, warranty='$warranty', in_stock=$in_stock WHERE id=$id");
